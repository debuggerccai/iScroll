...
export default class Scroller {
	...
	constructor(classNameW, classNameC, options, $vm) {
		...
		// direction X
		this.scrollBehaviorX = new Behavior(classNameW, classNameC, createBehaviorOptions({
		...
		// direction Y
		this.scrollBehaviorY = new Behavior(classNameW, classNameC, createBehaviorOptions({
			pullDownRefresh: this.options.pullDownRefresh,
			bounces: [top, bottom],
			rect: {
				size: 'height',
